...
def BookList():
    ...
    try:
        ...
        CanvasBookList.config(bg='#A2FF86')
        CanvasBookList.pack(expand=True , fill=BOTH)
        
        #Heading    
        bookListFrame = Frame(bookListRoot , bg='#A2FF86' , bd=5)
        bookListFrame.place(relx=0.25 , rely=0.1 , relwidth=0.5 , relheight=0.13)
            
        bookListLabel = Label(bookListFrame , text='Book List' , bg='#1B6B93' , fg='white' , font=('Arial Bold Italic' , 18))
        bookListLabel.place(relx=0 , rely=0 , relwidth=1 , relheight=1)
        
        #Treeview
        treeFrame = Frame(bookListRoot , bg='#1B6B93')
...
def SearchBook():
    ...
    try:
        ...
        CanvasBookSearch.config(bg='#F99B7D')
        CanvasBookSearch.pack(expand=True , fill=BOTH)

        #Heading
        bookSearchFrame = Frame(bookSearchRoot , bg='#F99B7D' , bd=5)
        bookSearchFrame.place(relx=0.25 , rely=0.1 , relwidth=0.5 , relheight=0.13)
        
        bookSearchLabel = Label(bookSearchFrame , text='Search Book' , bg='#8BACAA' , fg='white' , font=('Arial Bold Italic' , 18))
        bookSearchLabel.place(relx=0 , rely=0 , relwidth=1 , relheight=1)
        
        #Info
        bookSearchInfoFrame = Frame(bookSearchRoot , bg='#8BACAA')
        bookSearchInfoFrame.place(relx=0.1 , rely=0.3 , relwidth=0.8 , relheight=0.5)  
            
        SearchIDLabel = Label(bookSearchInfoFrame,text='Book ID : ' , bg='#8BACAA' , fg='white' , font=fonts)
        ...
        #Submit Button
        btnBookSearch = Button(bookSearchRoot , text='Search' , bg='#CBFFA9' , fg='black' , font=fonts , command=Search)
        btnBookSearch.place(relx=0.28 , rely=0.9 , relwidth=0.18 , relheight=0.08)
        
        #Quit Button
        btnQuitBookSearch = Button(bookSearchRoot , text='Exit' , bg='#FFD6A5' , fg='black' , font=fonts , command=bookSearchRoot.destroy)
...
def BorrowBook(): 
    ...
    try:
        ...
        CanvasBookBorrow.config(bg='#FFB84C')
        CanvasBookBorrow.pack(expand=True , fill=BOTH)

        #Heading
        bookBorrowFrame = Frame(bookBorrowRoot , bg='#FFB84C' , bd=5)
        bookBorrowFrame.place(relx=0.25 , rely=0.1 , relwidth=0.5 , relheight=0.13)
        
        bookBorrowLabel = Label(bookBorrowFrame , text='Borrow Book' , bg='#ACBCFF' , fg='white' , font=('Arial bold italic' , 18))
        bookBorrowLabel.place(relx=0 , rely=0 , relwidth=1 , relheight=1)
        
        #Info
        bookBorrowInfoFrame = Frame(bookBorrowRoot , bg='#ACBCFF')
        bookBorrowInfoFrame.place(relx=0.1 , rely=0.3 , relwidth=0.8 , relheight=0.5)  
            
        BorrowIDLabel = Label(bookBorrowInfoFrame,text='Book ID : ' , bg='#ACBCFF' , fg='white' , font=fonts)
        ...
        #Submit Button
        btnBookBorrow = Button(bookBorrowRoot , text='Borrow' , bg='#CBFFA9' , fg='black' , font=fonts , command=Borrow)
        btnBookBorrow.place(relx=0.28 , rely=0.9 , relwidth=0.18 , relheight=0.08)
        
        #Quit Button
        btnQuitBookBorrow = Button(bookBorrowRoot , text='Exit' , bg='#FFD6A5' , fg='black' , font=fonts , command=bookBorrowRoot.destroy)
...
def ReturnBook(): 
    ...
    try:
        ...
        CanvasBookReturn.config(bg='#FFC26F')
        ...
        bookReturnLabel = Label(bookReturnFrame , text='Return Book' , bg='#F9E0BB' , fg='Black' , font=('Arial bold italic' , 18))
        bookReturnLabel.place(relx=0 , rely=0 , relwidth=1 , relheight=1)
        
        #Info
        bookReturnInfoFrame = Frame(bookReturnRoot , bg='#F9E0BB')
        bookReturnInfoFrame.place(relx=0.1 , rely=0.3 , relwidth=0.8 , relheight=0.5)   
            
        ReturnIDLabel = Label(bookReturnInfoFrame , text='Book ID : ' , bg='#F9E0BB' , fg='Black' , font=fonts)
        ...
        #Submit Button
        btnBookReturn = Button(bookReturnRoot , text='Return' , bg='#CBFFA9' , fg='black' , font=fonts , command=Return)
        btnBookReturn.place(relx=0.28 , rely=0.9 , relwidth=0.18 , relheight=0.08)
        
        #Quit Button
        btnQuitBookReturn = Button(bookReturnRoot , text='Exit' , bg='#FFD6A5' , fg='black' , font=fonts , command=bookReturnRoot.destroy)
...
def AddBook():
    ...
    CanvasBookAdd.config(bg='#F3AA60')
    CanvasBookAdd.pack(expand=True , fill=BOTH)
        
    #Heading
    bookAddFrame = Frame(bookAddRoot , bg='#468B97' , bd=5)
    bookAddFrame.place(relx=0.25 , rely=0.1 , relwidth=0.5 , relheight=0.13)

    bookAddLabel = Label(bookAddFrame , text='Add Book' , bg='#468B97' , fg='white' , font=('Arial Bold Italic' , 18))
    bookAddLabel.place(relx=0 , rely=0 , relwidth=1 , relheight=1)

    #Info
    bookAddInfoFrame = Frame(bookAddRoot , bg='#468B97')
    bookAddInfoFrame.place(relx=0.1 , rely=0.3 , relwidth=0.8 , relheight=0.5)
    
    AddTitleLabel = Label(bookAddInfoFrame , text='Book Title : ' , bg='#468B97' , fg='white' , font=fonts)
    ...
    AddAuthorLabel = Label(bookAddInfoFrame,text='Book Author : ' , bg='#468B97' , fg='white' , font=fonts)
    ...
    #Submit Button
    SubmitBtn = Button(bookAddRoot,text='Add' , bg='#CBFFA9' , fg='black' , font=fonts , command=Add)
    SubmitBtn.place(relx=0.28 , rely=0.9 , relwidth=0.18 , relheight=0.08)
    
    #Quit Button
    btnQuitBookAdd = Button(bookAddRoot , text='Exit' , bg='#FFD6A5' , fg='black' , font=fonts , command=bookAddRoot.destroy)
...
def DeleteBook(): 
    ...
    try:
        ...
        #Heading
        bookDeleteFrame = Frame(bookDeleteRoot , bg='white' , bd=5)
        bookDeleteFrame.place(relx=0.25 , rely=0.1 , relwidth=0.5 , relheight=0.13)
            
        bookDeleteLabel = Label(bookDeleteFrame, text='Delete Book' , bg='#D3D04F', fg='white', font=('Arial Bold italic' , 18))
        bookDeleteLabel.place(relx=0 , rely=0 , relwidth=1 , relheight=1)
        
        #Info
        bookDeleteInfoFrame = Frame(bookDeleteRoot , bg='#D3D04F')
        bookDeleteInfoFrame.place(relx=0.1 , rely=0.3 , relwidth=0.8 , relheight=0.5)   

        DeleteIDLabel = Label(bookDeleteInfoFrame,text='Book ID : ' , bg='#D3D04F' , fg='white' , font=fonts)
        ...
        #Submit Button
        SubmitBtn = Button(bookDeleteRoot , text='Delete' , bg='#CBFFA9' , fg='black' , font=fonts , command=Delete)
        SubmitBtn.place(relx=0.28 , rely=0.9 , relwidth=0.18 , relheight=0.08)
        
        #Quit Button
        btnQuitBookDelete = Button(bookDeleteRoot,text='Exit' , bg='#FFD6A5' , fg='black' , font=fonts , command=bookDeleteRoot.destroy)
...
backgroundImage =Image.open('src/bg.jpg')
[imageSizeWidth , imageSizeHeight] = backgroundImage.size

newImageSizeWidth = int(imageSizeWidth*0.30)
...
#Heading
welcomeFrame = Frame(library_app, bd=5)
welcomeFrame.place(relx=0.2 , rely=0.05 , relwidth=0.6 , relheight=0.16)

welcomeLabel = Label(welcomeFrame, text='Library Management' , bg='#468B97' , fg='white' , font=('Arial Bold' , 18))
welcomeLabel.place(relx=0 , rely=0 , relwidth=1 , relheight=1)

#Buttons
btnBookList = Button(library_app , text='List of Books' , bg='#DFA878' , fg='#071952' , font=fonts , command=BookList)
btnBookList.place(relx=0.28 , rely=0.25 , relwidth=0.45 , relheight=0.1)

btnBookSearch = Button(library_app , text='Search your Book' , bg='#EF6262' , fg='#071952' , font=fonts , command=SearchBook)
btnBookSearch.place(relx=0.28 , rely=0.35 , relwidth=0.45 , relheight=0.1)

btnBookBorrow = Button(library_app , text='Borrow a Book' , bg='#DFA878' , fg='#071952' , font=fonts , command=BorrowBook)
btnBookBorrow.place(relx=0.28 , rely=0.45 , relwidth=0.45 , relheight=0.1)
    
btnBookReturn = Button(library_app , text='Return a Book' , bg='#EF6262' , fg='#071952' , font=fonts , command=ReturnBook)
btnBookReturn.place(relx=0.28 , rely=0.55 , relwidth=0.45 , relheight=0.1)

btnBookAdd = Button(library_app , text='Add a Book' , bg='#DFA878' , fg='#071952' , font=fonts , command=AddBook)
btnBookAdd.place(relx=0.28 , rely=0.65 , relwidth=0.45 , relheight=0.1)

btnBookDelete = Button(library_app , text='Delete a Book' , bg='#EF6262' , fg='#071952' , font=fonts , command=DeleteBook)
btnBookDelete.place(relx=0.28 , rely=0.75 , relwidth=0.45 , relheight=0.1)

btnQuit = Button(library_app , text='Exit Library' , bg='#DFA878' , fg='#071952' , font=fonts , command=library_app.destroy)
